...
classification_metrics_mc(true_labels, pred_vi)
...
classification_metrics_mc(true_labels[mask], pred_vi[mask])
...
#%%
var_hist(var[mask], 'Filtered Mask = 2.0')
...
# %%
#Set up f1 and percentage of data retained arrays
f1 = np.zeros(8)
...
for num in range(125,1100,125):
    ...
    data_percentage[jj] = len(true_labels_filt)/47640
    jj+=1
#%%
