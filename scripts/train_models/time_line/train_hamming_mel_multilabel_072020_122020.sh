...
#SBATCH --output=train_multilabel_mel_072020_122020_v2-%j.txt
...
python3 main.py --data_dir='/smallwork/beards/CS4321/acoustic_datasets/test_data' \
                --checkpoint_dir='/smallwork/beards/CS4321/AVBW_Team/cs4321-team-sonar-final-project/outputs/model_training/current_runs/test_train/' --overlap=75 --sample_pts=1024 --mel_bins=128 --batch_size=256 \
