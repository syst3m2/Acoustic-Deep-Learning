#!/bin/bash
#SBATCH --job-name=0106_19_datagen
#SBATCH --nodes=1
...
#SBATCH --output=gen_data_2019_01_06-%j.txt
...
python main_pipeline.py --length=30 --output_data='mel' \
                        ...
                        --channels=4 --label_range=20 --sample_rate=4000 --start_date '20190604' --end_date '20190701' \
