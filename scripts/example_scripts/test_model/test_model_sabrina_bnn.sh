...
#SBATCH --output=z_saved-model-bnn-6month-%j.txt
...
python3 main.py --data_dir='/smallwork/beards/CS4321/acoustic_datasets/multiclass_mel_012019_082021/' \
                --checkpoint_dir='/smallwork/beards/CS4321/AVBW_Team/cs4321-team-sonar-final-project/thesis_working/test_models/4-channel-dropout-bnn/predict_6month/' --overlap=75 --sample_pts=1024 --mel_bins=128 --batch_size=256 \
               ...
               --start_date='20190811 000000' --end_date='20200212 000000' --dataset='tfrecord'
