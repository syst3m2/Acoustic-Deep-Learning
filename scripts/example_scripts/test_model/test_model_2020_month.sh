...
#SBATCH --output=z_saved-model-2020-pred-month-%j.txt
...
python3 main.py --data_dir='/smallwork/beards/CS4321/acoustic_datasets/old_data/multilabel_mel_012019_082021/' \
                --checkpoint_dir='/smallwork/beards/CS4321/AVBW_Team/cs4321-team-sonar-final-project/outputs/model_training/to_compare/2020/output_mel_multilabel_2020_v2_cont_v2/predict_month/' --overlap=75 --sample_pts=1024 --mel_bins=128 --batch_size=256 \
               --saved_model_path='/smallwork/beards/CS4321/AVBW_Team/cs4321-team-sonar-final-project/outputs/model_training/to_compare/2020/output_mel_multilabel_2020_v2_cont_v2/checkpoint01--0.69.h5' \
               ...
               --start_date='20210101 000000' --end_date='20210201 000000' --callbacks=''
