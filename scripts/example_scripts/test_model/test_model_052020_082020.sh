...
#SBATCH --output=saved-model-052020-082020-%j.txt
...
python3 main.py --data_dir='/smallwork/beards/CS4321/acoustic_datasets/multilabel_mel_012021_082021/' \
                --checkpoint_dir='/smallwork/beards/CS4321/AVBW_Team/cs4321-team-sonar-final-project/model_output/to_compare/output_mel_multilabel_hamming_052020_082020_v1/' --overlap=75 --sample_pts=1024 --mel_bins=128 --batch_size=256 \
               --saved_model_path='/smallwork/beards/CS4321/AVBW_Team/cs4321-team-sonar-final-project/model_output/to_compare/output_mel_multilabel_hamming_052020_082020_v1/checkpoint269--0.90.h5' \
