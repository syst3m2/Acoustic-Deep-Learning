...
#SBATCH --output=saved-model-092019-032020-%j.txt
...
python3 main.py --data_dir='/smallwork/beards/CS4321/acoustic_datasets/multilabel_mel_012021_082021/' \
                --checkpoint_dir='/smallwork/beards/CS4321/AVBW_Team/cs4321-team-sonar-final-project/model_output/to_compare/output_mel_multilabel_hamming_092019_032020_v3/' --overlap=75 --sample_pts=1024 --mel_bins=128 --batch_size=256 \
               --saved_model_path='/smallwork/beards/CS4321/AVBW_Team/cs4321-team-sonar-final-project/model_output/to_compare/output_mel_multilabel_hamming_092019_032020_v3/checkpoint324--0.88.h5' \
