...
#SBATCH --output=z_saved-model-2019-pred-week-%j.txt
...
python3 main.py --data_dir='/smallwork/beards/CS4321/acoustic_datasets/old_data/multilabel_mel_012019_082021/' \
                --checkpoint_dir='/smallwork/beards/CS4321/AVBW_Team/cs4321-team-sonar-final-project/outputs/model_training/to_compare/output_mel_multilabel_cs4921_2019_v2/predict_week/' --overlap=75 --sample_pts=1024 --mel_bins=128 --batch_size=256 \
               ...
               --start_date='20200101 000000' --end_date='20200108 000000' --callbacks=''
