...
#SBATCH --output=train_multilabel_01_06_2020_week-%j.txt
...
python3 main.py --data_dir='/smallwork/beards/CS4321/acoustic_datasets/multilabel_mel_012019_082021' \
                --checkpoint_dir='/smallwork/beards/CS4321/AVBW_Team/cs4321-team-sonar-final-project/outputs/model_training/current_runs/multilabel_2020_week_split' --overlap=75 --sample_pts=1024 --mel_bins=128 --batch_size=256 \
               ...
               --start_date='20200101' --end_date='20200531' --test_data_type='new_split' --shuffle_group='week'
